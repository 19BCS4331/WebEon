...
router.put("/currencyProfile", authMiddleware, async (req, res) => {
  ...
  const query = `
    UPDATE "mCurrency"
    SET "vCncode" = $2, "vCnName" = $3, "nPriority" = $4, "nRatePer" = $5, "nDefaultMinRate" = $6, "nDefaultMaxRate" = $7, "vCalculationMethod" = $8, "nOpenRatePremium" =$9, "nGulfDiscFactor" = $10, "bIsActive" = $11,"vAmexCode"=$12,"vCountryName"=$13,"bTradedCurrency" =$14
    WHERE "nCurrencyID" = $1
    `;
